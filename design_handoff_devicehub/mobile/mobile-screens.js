...
(function () {
  ...
  const STATUS = {
    ...
    "in-storage": { label: "In storage", tone: "info",    dot: true },
    "in-repair":  { label: "In repair",  tone: "warning", dot: true },
  ...
  const DEVICES = [
    { code:"DEV-2041-XPS", name:"Dell XPS 15 9530", group:"Laptop", dept:"Engineering", status:"in-use", cond:88, flags:["warranty-expiring"] },
    { code:"DEV-2088-MBP", name:"MacBook Pro 14 M3", group:"Laptop", dept:"Design", status:"in-use", cond:95, flags:[] },
    { code:"DEV-3110-U27", name:"Dell UltraSharp U2723", group:"Monitor", dept:"Design", status:"in-use", cond:72, flags:[] },
    { code:"DEV-5210-NAS", name:"Synology RS1221+", group:"Server", dept:"IT", status:"in-repair", cond:54, flags:["inventory-overdue"] },
    { code:"DEV-4501-LJ", name:"HP LaserJet M428", group:"Printer", dept:"Operations", status:"in-storage", cond:63, flags:[] },
    { code:"DEV-7001-C920", name:"Logitech C920", group:"Peripheral", dept:"Sales", status:"retired", cond:30, flags:[] },
  ];

  const MEMBERS = [
    { name:"Anh Tran", email:"anh.tran@sioux.asia", role:"IT Admin", roleTone:"primary", roleIcon:"shield-check", dept:"IT", devices:42, status:"active", you:true },
    { name:"Quan Bui", email:"quan.bui@sioux.asia", role:"IT Admin", roleTone:"primary", roleIcon:"shield-check", dept:"IT", devices:38, status:"active" },
    { name:"Mai Pham", email:"mai.pham@sioux.asia", role:"Manager", roleTone:"secondary", roleIcon:"user-cog", dept:"Design", devices:9, status:"active" },
    { name:"Khoa Le", email:"khoa.le@sioux.asia", role:"Manager", roleTone:"secondary", roleIcon:"user-cog", dept:"Product", devices:6, status:"active" },
    { name:"Tuan Vo", email:"tuan.vo@sioux.asia", role:"Viewer", roleTone:"muted", roleIcon:"eye", dept:"Finance", devices:0, status:"active" },
    { name:"Linh Dang", email:"linh.dang@sioux.asia", role:"Viewer", roleTone:"muted", roleIcon:"eye", dept:"HR", devices:0, status:"invited" },
  ];
  ...
  const screens = {
    ...
    overview: (nav) => screen(
      ...
      `<div class="mob-body">
        <div class="mob-kpis">
          <div class="mob-card mob-kpi"><div class="kh"><span class="kl">Total devices</span><span class="kic">${ic("hard-drive")}</span></div><div class="kv">12</div><div class="ks">16 units · 8 depts</div></div>
    ...
    devices: (nav) => screen(
      ...
      <div class="mob-chips">
        ...
        <div class="mob-chip">Dept ${ic("chevron-down")}</div>
      </div>
        ...
        ${DEVICES.map(d=>`
          <div class="mob-card" style="padding:13px 14px;display:flex;align-items:center;gap:12px">
            ...
            <div style="flex:1;min-width:0">
              ...
              <div class="mono" style="font-size:11.5px;color:var(--muted-foreground);margin:1px 0 7px">${d.code} · ${d.dept}</div>
    ...
    deviceDetails: (nav) => screen(
      ...
      `<div class="mob-body">
        ...
        <div class="mob-card">
          ...
          <div class="mob-dl"><div><div class="k">Group</div><div class="v">Laptop</div></div><div><div class="k">Department</div><div class="v">Engineering</div></div><div><div class="k">Serial</div><div class="v mono">5KQ8R2</div></div><div><div class="k">Location</div><div class="v">HCMC · F4 · E-12</div></div></div>
        </div>
        <div class="mob-card">
          ...
          <div class="mob-tl">
            ...
            <div class="mob-tlrow"><span class="mob-tldot">${ic("user-check")}</span><div><div class="ti">Allocated to Engineering</div><div class="tm">5 days ago</div></div></div>
    ...
    createDevice: () => screen(
      ...
      `<div class="mob-body" style="padding-bottom:120px">
        ...
        <div class="mob-field"><label class="mob-label">Department <span class="req">*</span></label><div class="mob-select">Select…${ic("chevron-down")}</div></div>
    ...
    departments: (nav) => screen(
      head({ title:"Departments", back:true, actions:`<span class="mob-iconbtn primary">${ic("plus")}</span>` }) +
      `<div class="mob-body">
        <div class="mob-card">
          ${[["Engineering","Linh Tran",3],["Design","Mai Nguyen",2],["Product","Hung Pham",2],["IT","Duc Hoang",2],["Operations","Trang Dao",1],["Sales","Quan Le",1]].map(([n,m,c])=>`
            <div class="mob-row"><span class="rm"><div class="rt">${n}</div><div class="rsub">${m}</div></span><span class="mob-badge secondary">${c} ${ic("arrow-right")}</span></div>`).join("")}
        </div>
      </div>` + tabbar("more", nav)),
    ...
    memberProfile: (nav) => screen(
      ...
      `<div class="mob-body">
        <div class="mob-phead"><span class="pa">AT</span><div class="pn">Anh Tran</div><div class="pe">anh.tran@sioux.asia</div><div class="pb">${badge("primary","IT Admin",false)}${badge("success","Active",true)}</div></div>
        <div class="mob-card">
          <div class="mob-sechead">${ic("id-card")}Details</div>
          <div class="mob-dl"><div><div class="k">Department</div><div class="v">IT</div></div><div><div class="k">Site</div><div class="v">HCMC</div></div><div><div class="k">Phone</div><div class="v mono">+84 28 7100 1010</div></div><div><div class="k">Member since</div><div class="v">Mar 2021</div></div></div>
        </div>
        <div class="mob-card">
